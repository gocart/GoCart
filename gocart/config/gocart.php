...
$config['address1']			= 'test';
$config['address2']			= 'test';
$config['country']			= 'test'; // use proper country codes only
$config['city']				= 'test'; 
$config['state']			= 'test';
$config['zip']				= '963';
...
$config['secure_base_url']	= 'http://'.$_SERVER['HTTP_HOST'].'/'; // should be https:// if ssl is installed
