...
/**
 *  Moneris Global Integration Classes
 *	 
 *	Note: This file has been modified from the supplied version 
 *	for interoperability with GoCart 2.x.
 *
 */
...
class mpgGlobals
{
	...
	// G.A.-C.S.D
	// Edited from original configuration to retrieve 
	//   host based on settings mode
	function __construct()
	{
		...
		$CI =& get_instance();
		$settings = $CI->Settings_model->get_settings('moneris');
