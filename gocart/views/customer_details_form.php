...
<?php } else { ?>
    ...
    <?php endif; ?>
                        <tr>
                            ...
                            <td>
                                <input type="checkbox" name="ship_to_bill_address" value="yes" id="ship_to_bill_address" onchange="toggle_shipping_address(this.checked)" <?php if (@$customer['ship_to_bill_address'] != 'false')
