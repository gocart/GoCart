...
.sortable
{
	...
	font-size:14px;
	font-weight:bold;
	background-image:url(<?php echo secure_base_url();?>images/admin/menu_builder_bg.gif);
...
function loop_menu($menu)
{
	...
	<li>
		<div class="sortable">
			<img class="handle" src="<?php echo secure_base_url();?>images/admin/grip.gif" style="float:left;margin-right:10px;"/>
...
{
	$('#sortable_container').append('<li><div class="sortable"><img class="handle" src="<?php echo secure_base_url();?>images/admin/grip.gif" style="float:left;margin-right:10px;"/><span rel="'+url+'">'+item_name+'</span><br style="clear:both;"/></div><ul class="sortable_container" style="margin-left:10px;"></ul></li>');
	enable_sortables();
}
