...
<div id="gc_tabs">
	<ul>
		<li><a href="#gc_banner_info">Banners</a></li>
	</ul>
	<div id="gc_banner_info">
		...
		<div class="gc_field2">
			...
			<?php if($id && $image != ''):?>
			<div style="text-align:center; padding:5px; border:1px solid #ccc;"><img src="<?php echo base_url();?>uploads/<?php echo $image;?>" alt="current"/><br/>Current File</div>
			<?php endif;?>
		</div>
