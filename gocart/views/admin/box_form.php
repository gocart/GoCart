...
$enable_on_alt	= array('class'=>'gc_tf1', 'id'=>'enable_on_alt', 'value' => set_value('enable_on', reverse_format($enable_on)));
$disable_on_alt	= array('class'=>'gc_tf1', 'id'=>'disable_on_alt', 'value' => set_value('disable_on', reverse_format($disable_on)));
...
<script type="text/javascript">
	$(document).ready(function() {
		$("#enable_on_alt").datepicker({ dateFormat: 'mm-dd-yy', altField: '#enable_on', altFormat: 'yy-mm-dd' });
		$("#disable_on_alt").datepicker({ dateFormat: 'mm-dd-yy', altField: '#disable_on', altFormat: 'yy-mm-dd' });
	});
</script>
