...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <?php endif; ?>
        <?php display_css(array('styles.css')); ?>
        <?php
//test for http / https for non hosted files
        ...
        <?php display_css(array('../js/jquery/colorbox/colorbox.css')); ?>
        <?php display_js(array('jquery/colorbox/jquery.colorbox-min.js', 'jquery/equal_heights.js')); ?>
                        ...
                        foreach ($pages as $page): if ($page->id != 143)://this is the "homepage" page. By skipping it, we're skipping anything under it.
                                ...
                                <li>
                                    <?php if (empty($page->content)): ?>
                                        <a href="<?php echo $page->url; ?>" <?php
                        if ($page->new_window == 1) {
                            echo 'target="_blank"';
                        }
                                        ?>><?php echo $page->menu_title; ?></a>
                                    <?php else: ?>
...
<?php echo form_open('cart/search'); ?>
                ...
                <a href="<?php echo base_url(); ?>">
                    <img src="/assets/images/logo.png" alt="<?php echo $this->config->item('company_name'); ?>">
                </a>
        ...
        <div class="wide_wrap">
            ...
            <img src="/assets/images/menu_left_wrap.gif" alt="left" class="main_menu_left_wrap"/>
            <img src="/assets/images/menu_right_wrap.gif" alt="right" class="main_menu_right_wrap"/>
